...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.8\textwidth]{Theory1.png}
...
\begin{figure}[ht]
    ...
    \includegraphics[width=0.45\textwidth]{Experiment1.png} 
    ...
    \includegraphics[width=0.45\textwidth]{Experiment2.png} 
    % \fbox{\begin{minipage}{0.45\textwidth} \centering \vspace{3cm} [Insert Figure 2: Instron Machine] \vspace{3cm} \end{minipage}}
...
\begin{figure}[h!]
    ...
    \includegraphics[width=0.5\textwidth]{Unstretched.png}     
...
\begin{table}[!h]
    ...
    \begin{tabular}{@{}p{1cm} p{1.5cm} p{2cm} p{2cm} p{1.5cm} p{2cm} p{1.5cm}@{}}
        ...
        \midrule
        1 & 2.98 & $20^{o}C$&$1.1^{o}C$ & $26.7\;N$ & & $1.4\;N$ \\
        \midrule
        2 & 9.3 & $25^{o}C$&$5^{o}C$ & $28.5\;N$ & & $1.8\;N$\\
        \midrule
        3 & 16.79 & $30^{o}C$&$5^{o}C$ & $28.9\;N$ & & $0.4\;N$\\
        \midrule
        4 & 45.35 & $35^{o}C$&$5^{o}C$ & $29.7\;N$ & & $0.8\;N$\\
        \bottomrule
    \end{tabular}
\end{table}
