...
\begin{figure}[!h]
    \centering
    \includegraphics[width=0.75\textwidth]{./Images/GraphA1.png}
...
\begin{table}[!h]
    ...
    \begin{tabular}{@{}p{1cm} p{1.5cm} p{2cm} p{2cm} p{1.5cm} p{2cm} p{1.5cm}@{}}
        ...
        \midrule
        1 & 2.98 & $20^{o}C$&$1.1^{o}C$ & $26.7\;N$ & 28.18 N & $1.4\;N$ \\
        \midrule
        2 & 9.3 & $25^{o}C$&$5^{o}C$ & $28.5\;N$ & 18.18 N & $1.8\;N$\\
        \midrule
        3 & 16.79 & $30^{o}C$&$5^{o}C$ & $28.9\;N$ & 13.63 N & $0.4\;N$\\
        \midrule
        4 & 45.35 & $35^{o}C$&$5^{o}C$ & $29.7\;N$ & 4.54 N & $0.8\;N$\\
        \bottomrule
    \end{tabular}
\end{table}

Expected Force was calculated acrroding to the Maxwell Model for stress relaxation, which has the equation $F = F_0 e^{-t/\tau}$.
