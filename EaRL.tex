...
These long molecules have stiff segments (like links in a chain) but can otherwise collapse and fold. In a solid, the chains are both "relaxed" (collapsed/folded) and entangled with each other. When you pull on the clumped-up chains, some elongate, reducing the configurational entropy.
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.8\textwidth]{./images/Unstretched.png} % Currently held by placeholder image until lab is complete and image is taken
...
\begin{thebibliography}{9}
    ...
    \bibitem{ReportAuthors} Lab report authors: Joshua H. Elkins, Author I, and Author II
\end{thebibliography}
